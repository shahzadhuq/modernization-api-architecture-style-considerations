...
1. Predefined action oriented nature leads to tight coupling with the underlying system resources; slight variation to existing use-case will likely require new function implementation.
